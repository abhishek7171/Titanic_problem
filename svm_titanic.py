...
if __name__ == '__main__':	
	...
	support = support.fit(features,result)
	print("DONE Fitting Train Data")

	print("Calculating score")
	scores = cross_val_score(support, features, result)
	...
	Output = support.predict(features)
	
	#np.savetxt("svm.csv",Output,delimiter=",",fmt="%s")	
